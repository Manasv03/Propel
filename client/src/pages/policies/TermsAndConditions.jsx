    ...
    return (
        <div className="min-h-screen bg-linear-to-b from-[#242124] to-[#000000] text-white p-8 overflow-y-auto">
            <div className="max-w-4xl mx-auto bg-gray-900/50 p-8 rounded-lg shadow-lg">
                <h1 className="text-3xl font-bold mb-6 border-b border-gray-700 pb-2">Terms and Conditions</h1>
                ...
                <div className="space-y-6 text-gray-300 text-sm">
                    ...
                    <h3 className="text-lg font-semibold text-white mt-4">The use of this website and our services is subject to the following terms of use:</h3>
